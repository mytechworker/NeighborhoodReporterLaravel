                        ...
                        <div class="form__inner form__inner--is-condensed">
                            <div class="form__item">
                                <label class="text-field text-field--is-outlined">
                                    <input aria-label="Enter your email address"  class="text-field__input" name="password" placeholder="Password" required="" type="password" value="" autofocus>
                                </label>
                            ...
                            <div class="form__item">
                                <label class="text-field text-field--is-outlined">
                                    <input aria-label="Enter your email address" autocomplete="email" class="text-field__input" name="password_confirmation" placeholder="Confirm password" required="" type="password" value="" autofocus>
                                </label>
                            ...
                            <div class="form__item">
                                <button class="btn btn--cta" type="submit">Reset Password</button>
                            </div>
