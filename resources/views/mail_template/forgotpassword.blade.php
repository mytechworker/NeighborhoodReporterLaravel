																...
																<tr>
																	<td align="left" style="font:14px/16px Arial;color:#888;padding:0 0 23px">
																		...
																		<div style="text-align: center; margin-top: 15px">
																			<a href="{{$base_url}}/reset-password/{{$data['token']}}" style="height:40px;background-color:#009e13;border:2px solid #009e13;border-radius:50px;color:#ffffff;display:block;font-family:verdana,helvetica,sans-serif;font-size:18px;line-height:40px;text-align:center;text-decoration:none;width:185px;margin: 0 auto" target="_blank">Reset Password</a>
																		</div>
																		<br>
																		<br>
