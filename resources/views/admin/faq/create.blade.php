    ...
    <div class="">
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_content">
                        <form class="form-horizontal form-label-left" action="{{ route('faqs.store') }}" method="POST" novalidate>
                            @csrf
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-6">
                                    <textarea id="mytextarea" required="required" name="description" class="form-control col-md-7 col-xs-12">{{ old('description') }}</textarea>
                                </div>
                            </div>
