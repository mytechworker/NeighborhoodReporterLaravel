                ...
                <div class="col-md-5 col-sm-5 col-xs-12 form-group pull-right top_search">
                    <div class="input-group">
                        <span class="input-group-btn text-right">
                            <a class="btn btn-default" href="{{ route('communities.create') }}" title="Create a Communitie">Add New Communitie</a>
                        </span>
                    </div>
                </div>
            </div>
                ...
                <div class="x_panel">
                    <div class="x_content">
                        <table class="table table-striped responsive-utilities jambo_table bulk_action myTable">
                            <thead>
                            <tr class="headings">
                                <th class="column-title">Communitie Id </th>
                                <th class="column-title">Region Name </th>
                                <th class="column-title">Communitie Name </th>
