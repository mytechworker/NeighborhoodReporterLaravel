    ...
    <div class="">
        <div class="page-title">
            <div class="title_left">
                <h3>Feature Business Details</h3>
            </div>
        </div>
                ...
                <div class="x_panel">
                    <div class="x_content">
                        <div class="item form-group">
                            <label class="control-label" for="name">Business Name :</label>&nbsp;<label class="control-label" for="name">{{ !empty($post_title->business_name) ? $post_title->business_name: '-' }} </label><br/>
