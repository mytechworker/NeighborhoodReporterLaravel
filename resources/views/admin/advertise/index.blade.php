    ...
    <div class="">
        <div class="page-title">
            ...
            <div class="title_left">
                <h3>Advertises List</h3>
            </div>
            <div class="title_right">
                <div class="col-md-5 col-sm-5 col-xs-12 form-group pull-right top_search">
                    <div class="input-group">
                        <span class="input-group-btn text-right">
                            <a class="btn btn-default" href="{{ route('advertises.create') }}" title="Create a Advertise">Add New Advertise</a>
                        </span>
                    </div>
                </div>
            </div>
                ...
                <div class="x_panel">
                    <div class="x_content">
                        <table class="table table-striped responsive-utilities jambo_table bulk_action myTable">
                            <thead>
                            <tr class="headings">
                                <th class="column-title">Advertise Id </th>
                                <th class="column-title">Business Name </th>
                                <th class="column-title">Zipcode </th>
                                <th class="column-title">Firstname </th>
                                <th class="column-title">Lastname </th>
                                <th class="column-title">Email </th>
                                <th class="column-title">Phoneno </th>
                                <th class="column-title">Advertising Goal </th>
                                <th class="column-title">About your Business </th>
    ...
    jQuery(document).ready(function() {
        ...
        var table = jQuery('.myTable').DataTable({
                ...
                columns: [
                    ...
                    {data: 'advertising_goal', name: 'advertising_goal'},
                    {data: 'about_your_business', name: 'about_your_business'},
