                ...
                <div class="col-md-5 col-sm-5 col-xs-12 form-group pull-right top_search">
                    <div class="input-group">
                        <span class="input-group-btn text-right">
                            <a class="btn btn-default" href="{{ route('faq_categories.create') }}" title="Create a Faq Category">Add New Faq Category</a>
                        </span>
                    </div>
                </div>
            </div>
                ...
                <div class="x_panel">
                    <div class="x_content">
                        <table class="table table-striped responsive-utilities jambo_table bulk_action myTable">
                            <thead>
                            <tr class="headings">
                                <th class="column-title">Faq Category Id </th>
                                <th class="column-title">Faq Category Title </th>
                                <th class="column-title">Faq Category Description </th>
