                ...
                <div class="x_panel">
                    <div class="x_content">
                        <div class="item form-group">
                            <label class="control-label" for="name">Post Title :</label>&nbsp;<label class="control-label" for="name">{{ !empty($post_title->post_title) ? $post_title->post_title: '-' }} </label><br/>
                            <label class="control-label" for="name">Post Author :</label>&nbsp;<label class="control-label" for="name">{{ !empty($user->name) ? $user->name: '-' }} {{'('.$user->email.')'}}</label>
                        </div>
                    </div>
                </div>
            </div>
