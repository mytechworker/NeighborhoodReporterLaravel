...
<meta name="description" content="My Neighborhood Reporter Classified Listing">
<!-- Open Graph / Facebook -->
<meta property="og:locale" content="{{str_replace('_', '-', app()->getLocale())}}">
<meta property="og:type" content="article">
<meta property="og:url" content="{{route('home')}}/content/classified">
<meta property="og:title" content="My Neighborhood Reporter">
<meta property="og:description" content="My Neighborhood Reporter Classified Listing">
...
<meta property="twitter:url" content="{{route('home')}}/content/classified">
<meta property="twitter:title" content="My Neighborhood Reporter">
<meta property="twitter:description" content="My Neighborhood Reporter Classified Listing">
    ...
    <div class="container">
        <div class="manage-tab">
            <ul class="nav nav-tabs" role="tablist">
                ...
                <li><a class="active" href="/content/classified">Classifieds</a></li>
                    ...
                    <div id="listings-wrapper">
                        <form id="js-listing-page-form" method="post">
                            <ul class="listings list-unstyled">
                                @if(count($info['classified']) > 0)
                                @foreach($info['classified'] as $lpost)
                                <li>
                                    <article class="node-listing border-bottom-solid clearfix">
                                        <div class="d-flex flex-sm-row flex-column flex-sm-wrap ">
                                            <div class="flex-basis-md-pct-15 flex-basis-sm-pct-20 flex-shrink-0 d-none d-sm-block pr-3 small">
                                                @if($lpost['image'] != '')
                                                <a href="/c/{{$lpost['id']}}/{{sanitizeStringForUrl($lpost['title'])}}" class="thumbnail w100px">
                                                    <img src="{{postgetImageUrl($lpost['image'],$lpost['created_at'])}}" width="100px" height="75px" alt="Test" title="Test" class="img-responsive">
                                                </a>
                                                @else
                                                No image uploaded. 
                                                <strong>
                                                    <a href="/classified/{{$lpost['id']}}/edit">[add image]</a>
                                                </strong>
                                                @endif
                                            </div>
                                            <div class="flex-basis-md-pct-65 flex-basis-sm-pct-80">
                                                <header class="test-event-text">
                                                    <a href="/c/{{$lpost['id']}}/{{sanitizeStringForUrl($lpost['title'])}}" class="bold">{{$lpost['title']}}</a>
                                                </header>
                                                <div class="d-flex flex-md-row flex-column flex-sm-wrap small">
                                                    <p class="flex-basis-md-pct-50 pr-3 text-success">
                                                        <span aria-hidden="true" class="text-standard fas fa-bullhorn"></span> 
                                                        <span class="text-standard bold">Classified</span> posted {{\Carbon\Carbon::parse($lpost['created_at'])->format('D, M j Y g:i a')}}
                                                    </p>
                                            ...
                                            <div class="flex-basis-md-pct-20 side-btn flex-basis-sm-pct-100 d-flex flex-md-column align-items-md-end"> 
                                                ...
                                                <a href="/classified/{{$lpost['id']}}/edit" class="btn btn-outline-cta">
                                                    <i class="fas fa-pencil-alt pr-2"></i>Edit
                                                </a>
                                                <div class="d-inline-block social-btn-icon">
                                                    <a href="https://www.facebook.com/sharer/sharer.php?u={{route('home')}}/e/{{$lpost['id']}}/{{sanitizeStringForUrl($lpost['title'])}}?utm_source=facebook&utm_medium=web&utm_campaign=share" target="_blank" class="facebook-link">
                                                        <span aria-hidden="true" class="fab fa-facebook-f facebook-link"></span>
                                                    </a> | 

                                                    <a href="https://twitter.com/intent/tweet?text={{$lpost['title']}}&amp;url={{route('home')}}/e/{{$lpost['id']}}/{{sanitizeStringForUrl($lpost['title'])}}?utm_source=twitter&utm_medium=web&utm_campaign=share" target="_blank" class="twitter-link">
                                                        <span aria-hidden="true" class="fab fa-twitter twitter-link"></span>
                                                    </a>
                                                </div>
                                            </div>
                                            <div class="flex-basis-md-pct-15 flex-basis-sm-pct-20 d-none d-sm-block mt-2 pr-4"></div>
                                            <div class="flex-basis-md-pct-65 flex-basis-sm-pct-65 mt-2 d-flex flex-sm-row flex-column align-items-start small"></div>
                                        </div>
                                    </article>
                                </li>
                                @endforeach
