    ...
    $.fn.timepicki = function (options) {
        ...
        return this.each(function () {
            ...
            var new_ele = $(
                    ...
                    "<div class='time'>" +
                    top_arrow_button +
                    "<div class='ti_tx'><input type='text' class='timepicki-input' placeholder='00'" + (settings.disable_keyboard_mobile ? "readonly" : "") + "></div>" +
                    bottom_arrow_button +
                    "</div>" +
                    "<div class='mins'>" +
                    top_arrow_button +
                    "<div class='mi_tx'><input type='text' class='timepicki-input' placeholder='00'" + (settings.disable_keyboard_mobile ? "readonly" : "") + "></div>" +
                    bottom_arrow_button +
                    "</div>");
            // if(settings.show_meridian){
            // 	new_ele.append(
